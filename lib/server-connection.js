...
//added for logging certain objects but not necessarily used
...
var serverConnection = function(socket, server, closeConnectionServerCallback, smppDefs) {
    ...
    self.deliverMessage = function(params, optional) {
        //there are 2 functions called deliverMessage in this entire project
        //the console output is to track which one is being called at any given time
        //Heirachically this function will be called last since this is where the pdu for deliver_sm is merged into one object
        console.log("deliverMessage in lib/server-connection.js");
