...
exports.parse = function(buffer) {
    ...
    for (var i = 0; i < format.body.length; i++) {
        ...
        if (field.type == "int") {
            ...
            //there was an error in the line below which rendered the field short_message undefined. the initial declaration was:
            //buffer.copy(temp, 0, offset, offset + field.length);
            //field.length does not exist in the submit_sm pdu but length is declared as length_field as declared in line 161
